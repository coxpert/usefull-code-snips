<template>
  <div class="overlay">
    <div v-click-outside="close" class="dialog">
      <span class="close-dialog" @click="close">X</span>
      <div class="dialog-header">{{ title }}</div>
      <div class="dialog-body">{{ description }}</div>
      <div class="dialog-footer">
        <button class="btn-yes" @click="confirm">Yes</button>
        <button class="btn-no" @click="close">No</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    description: {
      type: String,
      default: 'Are you sure with this action?'
    }
  }
}
</script>
